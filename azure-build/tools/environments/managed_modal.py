...
class ManagedModalEnvironment(BaseModalExecutionEnvironment):
    ...
    def __init__(
        ...
        raise ValueError(
            "Managed Modal (Nous Tool Gateway) has been removed. "
            "Use TERMINAL_MODAL_MODE=direct with Modal credentials instead."
        )
        # Unreachable — kept so attribute annotations below type-check in editors.
