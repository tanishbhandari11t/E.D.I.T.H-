...
DEFAULT_CONFIG = {
    ...
    "dashboard": {
        ...
        "basic_auth": {
            "username": "",  # blank → plugin no-op unless users: is set
...
OPTIONAL_ENV_VARS = {
    ...
    # AZURE_OPENAI_* are aliases for the Foundry vars above (see runtime_provider).
    "AZURE_OPENAI_API_KEY": {
        "description": "Alias for AZURE_FOUNDRY_API_KEY (Azure OpenAI / Foundry)",
    ...
    "AZURE_OPENAI_ENDPOINT": {
        "description": "Alias for AZURE_FOUNDRY_BASE_URL (Azure OpenAI endpoint)",
    ...
    "AZURE_OPENAI_API_VERSION": {
        "description": "Azure OpenAI api-version query param (appended when URL lacks one)",
    ...
    "AZURE_OPENAI_DEPLOYMENT": {
        "description": "Azure OpenAI deployment name used when model/default is empty",
