...
def _print_setup_summary(config: dict, hermes_home):
    ...
    # Nous-managed Modal path removed.
...
def _run_portal_one_shot(config: dict) -> None:
    ...
    print()
    print_warning("Nous Portal / Tool Gateway setup was removed.")
    print_info("  Configure a model with `hermes model`.")
    print_info("  Configure tools with `hermes tools`.")
