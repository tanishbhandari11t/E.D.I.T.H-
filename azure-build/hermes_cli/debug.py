...
def _run_debug_share_nous(args, *, log_lines: int, redact: bool) -> None:
    """Handle ``hermes debug share --nous`` — diagnostics upload was removed."""
    print(
        "Nous diagnostics upload was removed.\n"
        "Use `hermes debug share --local` or `hermes debug share` instead.",
        file=sys.stderr,
    )
    raise SystemExit(1)
