...
def _(rid, params: dict) -> dict:
    """GET /api/billing/state — Portal billing was removed."""
    del params
    return _ok(rid, {
        "ok": False,
        "logged_in": False,
        "error": "provider_removed",
        "message": "Nous Portal billing was removed from this build.",
    })

@method("usage.bars")
def _(rid, params: dict) -> dict:
    """Shared dollar usage model — Portal billing was removed."""
    del params
    return _ok(rid, {
        "ok": False,
        "available": False,
...
def _(rid, params: dict) -> dict:
    """GET /api/billing/subscription — Portal billing was removed."""
    del params
    return _ok(rid, {
        "ok": False,
        "logged_in": False,
