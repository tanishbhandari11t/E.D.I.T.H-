...
.. code-block:: yaml
    ...
    branding:
      agent_name: "EDITH"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " EDITH "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "EDITH"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "EDITH",
            "welcome": "Welcome to EDITH! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " EDITH ",
            "prompt_symbol": "❯",
